...
python /afs/cern.ch/user/h/helfaham/CMSSW_8_4_0/src/Haamm/HaNaMiniAnalyzer/test/Plotter.py puScenario=$4 era=$5 

outfilename=`ls $4*$5*.root`
outfilenames=`ls *$4*$5*.root`

...
cd /afs/cern.ch/user/h/helfaham/CMSSW_11_0_0/src/Haamm/HaNaMiniAnalyzer/test/PUStudies
...
function produce {
    pileupCalc.py -i $ANJSON --inputLumiJSON ./pileup_JSON.txt --calcMode true --minBiasXsec $xsec --maxPileupBin $nBins2 --numPileupBins $nBins1 --pileupHistName=h_${xsecvariation} /eos/home-h/helfaham/data_$2_${xsecvariation}_${appendixName}.root
    
    echo pileupCalc.py -i $ANJSON --inputLumiJSON ./pileup_JSON.txt --calcMode true --minBiasXsec $xsec --maxPileupBin $nBins2 --numPileupBins $nBins1 --pileupHistName=h_${xsecvariation} /eos/home-h/helfaham/data_$2_${xsecvariation}_${appendixName}.root
